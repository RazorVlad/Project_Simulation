package visual.treeBuilders.disabledNode;
...
public class DisabledRenderer extends DefaultTreeCellRenderer {
	...
	private static final long serialVersionUID = 8432599013556783880L;
	...
	public DisabledRenderer() {
		this(new GraydIcon(UIManager.getIcon("Tree.leafIcon")), new GraydIcon(
				UIManager.getIcon("Tree.openIcon")), new GraydIcon(UIManager.getIcon("Tree.closedIcon")));
	}
